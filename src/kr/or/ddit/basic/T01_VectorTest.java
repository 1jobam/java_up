...
//		List v1 = new Vector();
		...
		v1.addElement("ccc"); //add와 같은 기능이나 Vector 타입에 예전부터 있던 키워드
		...
		//					=> 덮어쓴다. (반환 값 : 원래의 데이터)
		String temp = (String)v1.set(0, "zzz"); // 기존데이터를 보관할수도있다.
		...
		// 만약 제너릭을 사용하지 않은 Collection을 향상된 for문으로 처리할
		// 경우에는 Object형으로 처리한다.
		for(Object obj : v1) {
